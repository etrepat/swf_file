...
class SwfFileTest < Test::Unit::TestCase
  ...
  context "SwfFile" do
    context "instance methods" do
      ...
      should "raise an error if an invalid uri is provided" do
        assert_raise(RuntimeError) { SwfFile::FlashFile.new "http://www.blah.com/dummy_swf" }
      end
    ...
    context "class method header (local)" do
